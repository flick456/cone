...
module.exports = {
name: "rr-add",
description: "To add a reaction role",
usage: "rr-add <#channel/channel_id> <message_id> <@role/role_id/> <emoji>",
aliases: ["rradd"], 
...
async run(client, message, args) {
 if (!message.member.hasPermission("MANAGE_ROLES")) 
    ...
    if (!message.guild.me.hasPermission("MANAGE_ROLES")) return message.channel.send(`I don't have permission to manage roles!`)
const embed = new Discord.MessageEmbed() 
.setColor("RED") 
.setTitle("Reaction Role Add") 
.addField("Usage", `\`rr-add <#channel/channel_id> <message_id> <@role/role_id/> <emoji>\``) 
