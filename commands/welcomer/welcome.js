module.exports =  {
name: "welcome", 
aliases: ["joinmessage-preview", "joinmsg show"], 
description: "To preview the welcome message",
usage: "welcome",
category: "welcomer",
...
const member = message.member;
    ...
    if (joinChannel === null) return message.channel.send(`\`joinchannel\` **|** Please set a welcome channel first to preview it.`) 
...
.then(async() => 
  message.channel.send(`✅ **|** Welcome Message preview has been sent to <#${joinChannel}>`)) 
} catch (e) {
  console.error(e)
